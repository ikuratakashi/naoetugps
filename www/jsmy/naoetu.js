...
naoetu.mapAjax.prototype = {
    ...
    SendPos : function(){
        ...
        //----------
        if(RunMode == "Http"){
            var ajaxObj = $.ajax('https://27.120.99.9:50001/gpswrite',ajaxParam)
    ...
    getPosDatas : function(){
        ...
        var ajaxObj = $.ajax('https://27.120.99.9:50001/gpsread',ajaxParam)
...
naoetu.main.prototype = {
    ...
    SetSocketOn : function(pNameSpace){
        ...
        _socket.on("get PosDatas",naoetu.bind(_ASB,_ASB.getPosDatas));
...
naoetu.socket.prototype = {
    ...
    connection : function(){
        ...
        var _con = function(pNameSpace){
            return io.connect("https://27.120.99.9:50001/" + pNameSpace);
        }
